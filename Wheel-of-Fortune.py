...
# WOFHumanPlayer CLASS (from part B)
...
Guess a letter, phrase, or type 'exit' or 'pass':""".format(self.name,self.prizeMoney,category,obscuredPhrase,guessed))
        return move
# WOFComputerPlayer CLASS (from part C)
class WOFComputerPlayer(WOFPlayer):
    ...
    def getPossibleLetters(self,guessed):
        ...
        return guess
    def getMove(self,category,obscuredPhrase,guessed):
        g_lst=self.getPossibleLetters(guessed)
